...
namespace TranslateFileManagerBundle\DependencyInjection;
 ...
 */
class TranslateFileManagerExtension extends Extension
{
...
//            $config['webui']['enabled']
            if (false) {
                ...
                $container->setParameter('translate_file_manager.webui.enabled', false);
            }
...
//            }
    ...
    {
        $container->setParameter('translate_file_manager.webui.enabled', true);
        $container->setParameter('translate_file_manager.webui.allow_create', $config['webui']['allow_create']);
        $container->setParameter('translate_file_manager.webui.allow_delete', $config['webui']['allow_delete']);
        ...
        $container->setParameter('translate_file_manager.webui.file_base_path', \rtrim($path, '/').'/');
    }
